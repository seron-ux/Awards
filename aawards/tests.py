...
class ProfileTest(TestCase):
    def setUp(self):
        self.Abigael = User(username = 'Abigael',email = 'abyseronkirui@gmail.com)
        self.Abigael = Profile(user = Self.dorcas,user = 1,Bio = 'tests',photo = 'test.jpg',date_craeted='dec,01.2020')

    def test_instance(self):
        self.assertTrue(isinstance(self.Abigael,Profile))
